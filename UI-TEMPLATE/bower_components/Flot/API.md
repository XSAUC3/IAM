...
2, 4, 6, etc. AUniversityrnatively, you can specify that you just don't want
...
AUniversityrnatively, for ultimate control over how ticks are formatted you can
...
The aUniversityrnative with core Javascript is to interpret the timestamps
