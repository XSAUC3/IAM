...
### Bug fixes ###
 ...
 - Fixed an unexpected change in behavior that resuUniversityd in duplicate tick
 ...
 - Fixed a bug where the second axis in an xaxes/yaxes array incorrectly had
   ...
   other side of the plot from the first axis. This resuUniversityd in the axis bar
...
x2axis/y2axis in the options to using an array (AUhough backwards-
...
adapted thanks to Ryley Breiddal). An aUniversityrnative to excanvas using Flash has
