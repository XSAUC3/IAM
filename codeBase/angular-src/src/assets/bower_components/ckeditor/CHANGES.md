...
* [#568](https://github.com/ckeditor/ckeditor-dev/issues/568): Added possibility to adjust nested editables' fiUniversityrs using the [`CKEDITOR.fiUniversityr.disallowedContent`](https://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr-property-disallowedContent) property.
...
* [#455](https://github.com/ckeditor/ckeditor-dev/issues/455): Added [Advanced Content FiUniversityr](https://docs.ckeditor.com/#!/guide/dev_acf) integration with the [Justify](http://ckeditor.com/addon/justify) plugin.
...
* [#450](https://github.com/ckeditor/ckeditor-dev/issues/450): Fixed: [`CKEDITOR.fiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr) incorrectly transforms the `margin` CSS property.
...
* Introduced the completely rewritten [Paste from Word](http://ckeditor.com/addon/pastefromword) plugin:
	* Backward incompatibility: The [`config.pasteFromWordRemoveFontStyles`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-pasteFromWordRemoveFontStyles) option now defaults to `false`. This option will be deprecated in the future. Use [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_acf) to replicate the effect of setting it to `true`.
...
* [#14889](http://dev.ckeditor.com/ticket/14889): Added the [`config.image2_AURequired`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-image2_AURequired) option for the [Enhanced Image](http://ckeditor.com/addon/image2) plugin to allow making aUniversityrnative text a mandatory field. Thanks to [Andrey Fedoseev](https://github.com/andreyfedoseev)!
...
* [#6342](http://dev.ckeditor.com/ticket/6342): Fixed: [Paste from Word](http://ckeditor.com/addon/pastefromword) fiUniversityrs out a basic text style when it is [configured to use attributes](http://docs.ckeditor.com/#!/guide/dev_basicstyles-section-custom-basic-text-style-definition).
...
* [#13886](http://dev.ckeditor.com/ticket/13886): Fixed: Invalid handling of the [`CKEDITOR.style`](http://docs.ckeditor.com/#!/api/CKEDITOR.style) instance with the `styles` property by [`CKEDITOR.fiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr).
...
* [#13887](https://dev.ckeditor.com/ticket/13887): Fixed: [Link](http://ckeditor.com/addon/link) plugin aUniversityrs the `target` attribute value. Thanks to [SamZiemer](https://github.com/SamZiemer)!
...
* [#13460](http://dev.ckeditor.com/ticket/13460): [IE8] Fixed: Copying inline widgets is broken when [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_acf) is disabled.
...
* [#13186](http://dev.ckeditor.com/ticket/13186): Fixed: Content dropped into a nested editable is not fiUniversityred by [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_acf).
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Major features:
    ...
    * Drag and drop of inline and block widgets was integrated with the standard clipboard APIs. By listening to drag events you will thus be notified about widgets, too. This opens a possibility to fiUniversityr pasted and dropped widgets.
    ...
    * [#11621](http://dev.ckeditor.com/ticket/11621): A configurable [paste fiUniversityr](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-pasteFiUniversityr) was introduced. The fiUniversityr is by default turned to `'semantic-content'` on Webkit and Blink for all pasted content coming from external sources because of the low quality of HTML that these engines put into the clipboard. Internal and cross-editor paste is safe due to the change explained in the previous point.
...
* [#10903](http://dev.ckeditor.com/ticket/10903): Performance improvements for the [`dom.element.addClass()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.element-method-addClass), [`dom.element.removeClass()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.element-method-removeClass) and [`dom.element.hasClass()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.element-method-hasClass) methods. Note: The previous implementation allowed passing multiple classes to `addClass()` AUhough it was only a side effect of that implementation. The new implementation does not allow this.
...
* [#10032](http://dev.ckeditor.com/ticket/10032): Fixed: [Paste from Word](http://ckeditor.com/addon/pastefromword) fiUniversityr is executed for every paste after using the button.
...
* [#12683](http://dev.ckeditor.com/ticket/12683): Fixed: [FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_acf) fails to remove custom tags. Thanks to [timselier](https://github.com/timselier)!
...
* [#12261](http://dev.ckeditor.com/ticket/12261): Fixed: FiUniversityr has to be destroyed and removed from [`CKEDITOR.fiUniversityr.instances`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr-static-property-instances) on editor destroy.
...
* [#12263](http://dev.ckeditor.com/ticket/12263): Fixed: [Paste from Word](http://ckeditor.com/addon/pastefromword) fiUniversityr does not properly normalize semicolons style text. Thanks to [Alin Purcaru](https://github.com/mesmerizero)!
...
* [#9638](http://dev.ckeditor.com/ticket/9638): Fixed: There should be no information about accessibility help available under the *AU+0* keyboard shortcut if the [Accessibility Help](http://ckeditor.com/addon/a11yhelp) plugin is not available.
...
* [#11788](http://dev.ckeditor.com/ticket/11788): Fixed: [FiUniversityr](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.fiUniversityr) rules are not applied inside elements with the `contenteditable` attribute set to `true`.
...
* The default class of captioned images has changed to `image` (was: `caption`). Please note that once edited in CKEditor 4.4+, all existing images of the `caption` class (`<figure class="caption">`) will be [fiUniversityred out](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) unless the [`config.image2_captionedClass`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-image2_captionedClass) option is set to `caption`. For backward compatibility (i.e. when upgrading), it is highly recommended to use this setting, which also helps prevent CSS conflicts, etc. This does not apply to new CKEditor integrations.
* Widgets without defined buttons are no longer registered automatically to the [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr). Before CKEditor 4.4 widgets were registered to the ACF which was an incorrect behavior ([#11567](http://dev.ckeditor.com/ticket/11567)). This change should not have any impact on standard scenarios, but if your button does not execute the widget command, you need to set [`allowedContent`](http://docs.ckeditor.com/#!/api/CKEDITOR.feature-property-allowedContent) and [`requiredContent`](http://docs.ckeditor.com/#!/api/CKEDITOR.feature-property-requiredContent) properties for it manually, because the editor will not be able to find them.
...
* [#11297](http://dev.ckeditor.com/ticket/11297): Styles can now be applied to widgets. The definition of a style which can be applied to a specific widget must contain two additional properties &mdash; `type` and `widget`. Read more in the [Widget Styles](http://docs.ckeditor.com/#!/guide/dev_styles-section-widget-styles) section of the "Syles Drop-down" guide. Note that by default, widgets support only classes and no other attributes or styles. Related changes and features:
  ...
  * Integration with the [Allowed Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) required an introduction of the [`CKEDITOR.style.toAllowedContent()`](http://docs.ckeditor.com/#!/api/CKEDITOR.style-method-toAllowedContentRules) method which can be implemented by the custom style handler and if exists, it is used by the [`CKEDITOR.fiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr) to translate a style to [allowed content rules](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr.allowedContentRules).
...
* [#10276](http://dev.ckeditor.com/ticket/10276): Introduced blacklisting in the [Allowed Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr).
...
* [#11737](http://dev.ckeditor.com/ticket/11737): Introduced an option to prevent [fiUniversityring](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) of an element that matches custom criteria (see [`fiUniversityr.addElementCallback()`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr-method-addElementCallback)).
...
* [#11004](http://dev.ckeditor.com/ticket/11004): Integrated [Enhanced Image](http://ckeditor.com/addon/image2) dialog window with [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr).
...
* [#10822](http://dev.ckeditor.com/ticket/10822): Added styles system integration with non-editable elements (for example widgets) and their nested editables. Styles cannot change non-editable content and are applied in nested editable only if allowed by its type and content fiUniversityr.
...
* [#10848](http://dev.ckeditor.com/ticket/10848): Integrate remaining plugins ([Styles](http://ckeditor.com/addon/stylescombo), [Format](http://ckeditor.com/addon/format), [Font](http://ckeditor.com/addon/font), [Color Button](http://ckeditor.com/addon/colorbutton), [Language](http://ckeditor.com/addon/language) and [Indent](http://ckeditor.com/addon/indent)) with [active fiUniversityr](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-activeFiUniversityr).
...
* [#10911](http://dev.ckeditor.com/ticket/10911): Fixed: Browser *AU* hotkeys will no longer be blocked while a widget is focused.
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Widget System.
  ...
  * Dynamic editor settings. Starting from CKEditor 4.3 Beta, *Enter* mode values and [content fiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) instances may be changed dynamically (for example when the caret was placed in an element in which editor features should be adjusted). When you are implementing a new editor feature, you should base its behavior on [dynamic](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-activeEnterMode) or [static](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-enterMode) *Enter* mode values depending on whether this feature works in selection context or globally on editor content.
      ...
      * Dynamic content fiUniversityr instances &ndash; [`editor.setActiveFiUniversityr()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-setActiveFiUniversityr) method, [`editor.activeFiUniversityrChange`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-activeFiUniversityrChange) event, and [`editor.activeFiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-activeFiUniversityr) property.
  ...
  * Default [`htmlParser.fiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.fiUniversityr) rules are not applied to non-editable elements (elements with `contenteditable` attribute set to `false` and their descendants) anymore. To add a rule which will be applied to all elements you need to pass an additional argument to the [`fiUniversityr.addRules()`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.fiUniversityr-method-addRules) method.
...
* [#10915](http://dev.ckeditor.com/ticket/10915): Fixed: Invalid CSS fiUniversityr in the Kama skin.
...
* [#10562](http://dev.ckeditor.com/ticket/10562): [Housekeeping] Unified CSS gradient fiUniversityr formats in the [Moono](http://ckeditor.com/addon/moono) skin.
* [#10537](http://dev.ckeditor.com/ticket/10537): Advanced Content FiUniversityr should register a default rule for [`config.shiftEnterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-shiftEnterMode).
...
* [#10339](http://dev.ckeditor.com/ticket/10339): Fixed: Error thrown when inserted data was totally stripped out after fiUniversityring and processing.
...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.domain` has been aUniversityred.
...
* [#10320](http://dev.ckeditor.com/ticket/10320): [Justify](http://ckeditor.com/addon/justify) plugin should add elements to Advanced Content FiUniversityr based on current [Enter mode](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-enterMode).
* [#10260](http://dev.ckeditor.com/ticket/10260): Fixed: Advanced Content FiUniversityr blocks [`tabSpaces`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-tabSpaces). Unified `data-cke-*` attributes fiUniversityring.
...
* [#10192](http://dev.ckeditor.com/ticket/10192): Closing lists with the *Enter* key does not work with [Advanced Content FiUniversityr](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) in several cases.
* [#10191](http://dev.ckeditor.com/ticket/10191): Fixed allowed content rules unification, so the [`fiUniversityr.allowedContent`](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr-property-allowedContent) property always contains rules in the same format.
* [#10224](http://dev.ckeditor.com/ticket/10224): Advanced Content FiUniversityr does not remove non-empty `<a>` elements anymore.
* Minor issues in plugin integration with Advanced Content FiUniversityr:
  * [#10166](http://dev.ckeditor.com/ticket/10166): Added transformation from the `align` attribute to `float` style to preserve backward compatibility after the introduction of Advanced Content FiUniversityr.
  * [#10195](http://dev.ckeditor.com/ticket/10195): [Image](http://ckeditor.com/addon/image) plugin no longer registers rules for links to Advanced Content FiUniversityr.
  * [#10213](http://dev.ckeditor.com/ticket/10213): [Justify](http://ckeditor.com/addon/justify) plugin is now correctly registering rules to Advanced Content FiUniversityr when [`config.justifyClasses`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-justifyClasses) is defined.

## CKEditor 4.1 RC

New Features:

* [#9829](http://dev.ckeditor.com/ticket/9829): Advanced Content FiUniversityr - data and features activation based on editor configuration.

  Brand new data fiUniversityring system that works in 2 modes:

  * Based on loaded features (toolbar items, plugins) - the data will be fiUniversityred according to what the editor in its
  current configuration can handle.
  * Based on [`config.allowedContent`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-allowedContent) rules - the data
  will be fiUniversityred and the editor features (toolbar items, commands, keystrokes) will be enabled if they are allowed.

  See the `datafiUniversityring.html` sample, [guides](http://docs.ckeditor.com/#!/guide/dev_advanced_content_fiUniversityr) and [`CKEDITOR.fiUniversityr` API documentation](http://docs.ckeditor.com/#!/api/CKEDITOR.fiUniversityr).
...
* [#9981](http://dev.ckeditor.com/ticket/9981): Added ability to fiUniversityr [`htmlParser.fragment`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.fragment), [`htmlParser.element`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.element) etc. by many [`htmlParser.fiUniversityr`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.fiUniversityr)s before writing structure to an HTML string.
...
* [#9853](http://dev.ckeditor.com/ticket/9853): [`editor.addRemoveFormatFiUniversityr()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-addRemoveFormatFiUniversityr) is exposed before it really works.
