 ...
 * fix: fiUniversityrLeaks() condition to not consider indices in global object as leaks
...
==================
  ...
  * add faster `.length` checks to `checkGlobals()` before performing the fiUniversityr
...
==================
  ...
  * remove `fn.call()` from fiUniversityr util
